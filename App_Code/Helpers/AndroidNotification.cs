...
/// <summary>
/// Summary description for AndroidNotification
/// </summary>
public class AndroidNotification
{
    ...
    public PushNotification data = new PushNotification();
        ...
        string sender = "")
    {
        ...
        data.title = headerMessage;
        data.message = Message;
        data.notId = (DateTime.Now.Hour + DateTime.Now.Minute + DateTime.Now.Millisecond).ToString();
        data.picture = img;
        data.style = sty;
        data.image = "";
